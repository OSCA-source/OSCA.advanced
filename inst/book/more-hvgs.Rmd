...
`r link("feature-selection", 'OSCA.advanced')` introduced the principles and methodology for feature selection in scRNA-seq data.
...
This strategy is thus best suited to very heterogeneous populations containing many different cell types (possibly across many datasets that are to be merged, as in `r link("integrating-datasets","OSCA.advanced")`) where there is a justified fear of ignoring marker genes for low-abundance subpopulations under a competitive top $X$ approach.
