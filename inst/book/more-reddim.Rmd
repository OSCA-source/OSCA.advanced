...
vars_d <- colVars(ds[sce.zeisel$level1class == "microglia", ])
vars_t <- colVars(ts[sce.zeisel$level1class == "microglia", ])
stopifnot(mean(vars_d) > mean(vars_t))
```

These methods provide more information about transcriptional heterogeneity within clusters (Figures \@ref(fig:densne) and \@ref(fig:densmap)),
with the astrocyte and microglia clusters being less compact in the density-preserving versions.
