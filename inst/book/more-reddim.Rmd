...
<!-- NOTE: This section commented out due to issues with PCAtools -->
...
One strategy is to retain all PCs until the percentage of total variation explained reaches some threshold $T$.
