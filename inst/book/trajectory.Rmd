...
# TODO: https://github.com/LTLA/TrajectoryUtils/pull/3 to avoid having to set outscale.
pseudo.og <- quickPseudotime(sce.nest, use.dimred="PCA", outgroup=TRUE, outscale=1.5)
set.seed(10101)
plot(pseudo.og$mst)
```
...
Another option is to construct the MST based on distances between mutual nearest neighbor (MNN) pairs between clusters (Section \@ref(performing-mnn-correction)).
